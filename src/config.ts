...
export const themeConfig: ThemeConfig = {
  ...
  site: {
    ...
    // site description
    description: 'The personal blog of Sasiru Ravihansa — exploring code, design, and developer tools through a lens of clarity, precision, and beautiful typography.',
  ...
  comment: {
    ...
    waline: {
      // server url
      serverURL: 'https://comment.sasiru.eu.org',
      // emoji url
      emoji: [
  ...
  seo: {
    ...
    verification: {
      ...
      google: 'Y0kgfIBYjMW6DvEdZ7lqos7aHGfJrQe1nOg67bPsKh8',
    ...
    googleAnalyticsID: 'G-LZ6GH4CZSF',
    // umami analytics
